...
class App extends Component {
  ...
  signupHandler = (event, authData) => {
    ...
    fetch('http://localhost:8080/graphql', {
      ...
      if (resData.errors && resData.errors[2].code === 422) {
        throw new Error("Validation failed")
      }
      if (resData.errors) {
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <Layout
          header={< Toolbar > <MainNavigation
          onOpenMobileNav={this
          .mobileNavHandler
          .bind(this, true)}
          onLogout={this.logoutHandler}
          isAuth={this.state.isAuth}/> < /Toolbar>}
          mobileNav={< MobileNavigation open = {
